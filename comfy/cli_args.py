...
parser.add_argument("--enable-dev-node-reload", action="store_true", help="Enable development-only manual reload support for explicitly allowlisted custom node packs.")
parser.add_argument("--dev-reload-node-pack", type=str, nargs='+', default=[], help="Specify custom node folders that are allowed to use development-only manual reload.")
